const BillingDetails = ({ active }) => {
  return (
    <div
      className={`mt-6 pb-16 flex flex-col justify-between bg-neutral-100 py-2 px-6 rounded-md ${
        active ? "block" : "hidden"
      }`}
    >
